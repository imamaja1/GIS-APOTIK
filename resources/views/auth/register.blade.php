...
@section('title', 'Registrasi — GIS Apotik KLU')
...
@section('form')
    ...
    <form method="POST" action="{{ route('register.post') }}">
        ...
        {{-- Username --}}
        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-1.5 cursor-pointer" for="nama_user">
                Username
            </label>
            <input
                id="nama_user"
                ...
                class="w-full px-4 py-2.5 border rounded-lg text-sm transition bg-white text-gray-700
                       focus:outline-none focus:ring-1
                       {{ $errors->has('nama_user') ? 'border-red-400 focus:border-red-400 focus:ring-red-300' : 'border-gray-300 focus:border-green-500 focus:ring-green-400' }}"
            >
            @error('nama_user')
        ...
        {{-- Konfirmasi Password --}}
        <div class="mb-6">
            <label class="block text-sm font-medium text-gray-700 mb-1.5 cursor-pointer" for="password_confirmation">
                Ulang Password
            </label>
            <input
                ...
                autocomplete="new-password"
                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm transition
