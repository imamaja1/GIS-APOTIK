...
<div class="space-y-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div id="info-apotek"
            class="hidden mt-4 p-3 bg-green-50 border border-green-100 rounded-lg text-sm text-green-800">
...
<script>
    ...
    $('#tempat-tujuan').on('select2:select', function (e) {
        ...
        document.getElementById('info-apotek').classList.remove('hidden');
        updateGmapsButton();
    });
