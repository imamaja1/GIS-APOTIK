...
@section('content')
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 text-center">
            ...
            <div class="text-xs text-gray-400 font-medium uppercase tracking-wide mt-1">Total Apotik</div>
        </div>

        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-green-600">{{ $stats['apotek_buka'] }}</div>
            <div class="text-xs text-gray-400 font-medium uppercase tracking-wide mt-1">Apotik Buka</div>
        </div>

        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-red-500">{{ $stats['apotek_tutup'] }}</div>
            <div class="text-xs text-gray-400 font-medium uppercase tracking-wide mt-1">Apotik Tutup</div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
            ...
            <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wide">Peta KLU dan Apotik</h2>
        </div>
